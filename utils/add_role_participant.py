...
async def addRoleParticipant(bot, message: discord.message.Message, log, conn):
  ...
  if userRegistered != "UserNameNotFound":
    ...
    if userRegistered == "UserNameNotFound":
      ...
      await user.send("Oh ooh! We notice that you have not registered Login'22. Please register for any event of your choice! You will have to submit an email ID again for this purpose. If you have any queries with regard to this, feel free to reach out to the <#1020388821742927932> channel or <#1025079557117710436> or the server admin.\n\n Website : https://www.psglogin.in")
      return 0
    else:
      return 1
  return 0